import type { GroupMsgType, GroupPermission, GroupMemberRole, GroupType, GroupStatus, InvitePermission, MessagePermission } from '../../../../shared/types/group.js';
...
export interface SendGroupMessageDto {
  ...
  media?:     {
    url: string; publicId?: string; mimeType?: string;
    size?: number; name?: string; duration?: number;
    width?: number; height?: number; thumbnail?: string; waveform?: number[];
  }[];
}
