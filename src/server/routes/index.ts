...
import groupMemberRoutes        from '../modules/group-members/routes.js';
...
import groupInvitationRoutes    from '../modules/group-invitations/routes.js';
import groupJoinRequestRoutes   from '../modules/group-join-requests/routes.js';
...
apiRouter.use('/groups/:id/members', groupMemberRoutes);
...
apiRouter.use('/group-invitations', groupInvitationRoutes);
apiRouter.use('/group-join-requests', groupJoinRequestRoutes);
