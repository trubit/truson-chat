...
export type MediaFileType =
  'image' | 'video' | 'audio' | 'voice_note' | 'document' | 'gif' | 'sticker';
...
const mediaFileSchema = new Schema<IMediaFile>(
  {
    ...
    type: {
      type: String,
      enum: ['image', 'video', 'audio', 'voice_note', 'document', 'gif', 'sticker'],
      required: true,
    },
...
export const MediaFileModel: Model<IMediaFile> = mongoose.model<IMediaFile>(
  'MediaFile',
  mediaFileSchema,
);
