...
const REQUEST_FIELDS: SelectField<RequestVisibility>[] = [
  ...
  },
  {
    ...
    description: 'Who can find you via search',
    options: REQUEST_OPTS,
  },
];
...
function SettingRow<T extends string>({
  ...
  field: SelectField<T>;
  control: ReturnType<typeof useForm<UpdatePrivacyDto>>['control'];
  options: { value: T; label: string }[];
  isLoading: boolean;
}) {
  return (
      ...
      >
                ...
                <FormControlLabel
                  ...
                  label={
                    <Box>
                      ...
                      <Typography variant="caption" color="text.secondary">
                        Show your profile in suggestions
                      </Typography>
                    </Box>
                  }
              ...
              render={({ field: f }) => (
                <FormControlLabel
                  ...
                  label={
                    <Box>
                      <Typography variant="body2" sx={{ fontWeight: 600 }}>
                        Accept contact requests from anyone
                      </Typography>
                      <Typography variant="caption" color="text.secondary">
                        If off, only friends can add you as a contact
                      </Typography>
                    </Box>
                  }
                  labelPlacement="start"
        ...
        <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
          <Button
            ...
            variant="contained"
            startIcon={
              update.isPending ? <CircularProgress size={16} color="inherit" /> : <SaveIcon />
            }
